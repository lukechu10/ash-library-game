...
<div class="w-full sort-game-view">
    ...
    <Overlay active={startDimmerActive}>
        <div class="max-w-md card">
            <h3 class="self-center text-lg font-bold">Choisir les paramètres du jeu</h3>
            <div class="mr-10 mb-5 ml-10 d-flex justify-space-around difficulty-radios">
                <fieldset class="flex flex-col">
                    ...
                    <div class="flex flex-col">
                        <label class="flex items-center">
                            <input type="radio" class="radio" bind:group={numOfBooks} value={3} />
                            3 livres
                        </label>
                        <label class="flex items-center">
                            <input type="radio" class="radio" bind:group={numOfBooks} value={4} />
                            4 livres
                        </label>
                        <label class="flex items-center">
                            <input type="radio" class="radio" bind:group={numOfBooks} value={6} />
                            6 livres
                        </label>
                    </div>
                </fieldset>
            ...
            <div class="flex justify-center">
                <button class="bg-red-500 btn hover:bg-red-600" on:click={startGame}>
                    Commencer
                </button>
            </div>
        </div>
    ...
    <Overlay active={continueDimmerActive}>
        <button class="bg-red-500 btn hover:bg-red-600" on:click={continueGame}>Continuer</button>
    </Overlay>
